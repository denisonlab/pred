    ...
    case 1
        ...
        for i= 1:nTrials
            for iJ = 1:2 % Standard then test
                [mask,~,~]=kt_makeFilteredNoise(p.gratingSize, 0.5,0, 0, p.gratingSF/2, p.gratingSF*2,pixelsPerDegree, 0,'allOrientations');
                mask=rd_aperture(mask, 'gaussian', gratingRadiusS(1)/4);
